...
%prep
%setup -q -n girara-0.3.5
cd %{_builddir}/girara-0.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597080215
...
cp %{_builddir}/girara-0.3.5/LICENSE %{buildroot}/usr/share/package-licenses/girara/b83b4f7c22a9086f4e1f8c8ce8e0cece97ea2a21
