...
Version  : 0.3.4
Release  : 3
URL      : https://github.com/pwmt/girara/archive/0.3.4/girara-0.3.4.tar.gz
Source0  : https://github.com/pwmt/girara/archive/0.3.4/girara-0.3.4.tar.gz
...
%prep
%setup -q -n girara-0.3.4
cd %{_builddir}/girara-0.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578358241
...
cp %{_builddir}/girara-0.3.4/LICENSE %{buildroot}/usr/share/package-licenses/girara/b83b4f7c22a9086f4e1f8c8ce8e0cece97ea2a21
