...
Version  : 0.3.6
Release  : 6
URL      : https://github.com/pwmt/girara/archive/0.3.6/girara-0.3.6.tar.gz
Source0  : https://github.com/pwmt/girara/archive/0.3.6/girara-0.3.6.tar.gz
...
%prep
%setup -q -n girara-0.3.6
cd %{_builddir}/girara-0.3.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626735134
...
cp %{_builddir}/girara-0.3.6/LICENSE %{buildroot}/usr/share/package-licenses/girara/b83b4f7c22a9086f4e1f8c8ce8e0cece97ea2a21
