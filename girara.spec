...
Version  : 0.4.4
Release  : 12
URL      : https://github.com/pwmt/girara/archive/0.4.4/girara-0.4.4.tar.gz
Source0  : https://github.com/pwmt/girara/archive/0.4.4/girara-0.4.4.tar.gz
...
%prep
%setup -q -n girara-0.4.4
cd %{_builddir}/girara-0.4.4
pushd ..
cp -a girara-0.4.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720104307
