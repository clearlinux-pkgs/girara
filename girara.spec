...
Version  : 0.3.7
Release  : 7
URL      : https://github.com/pwmt/girara/archive/0.3.7/girara-0.3.7.tar.gz
Source0  : https://github.com/pwmt/girara/archive/0.3.7/girara-0.3.7.tar.gz
...
%prep
%setup -q -n girara-0.3.7
cd %{_builddir}/girara-0.3.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644949765
...
cp %{_builddir}/girara-0.3.7/LICENSE %{buildroot}/usr/share/package-licenses/girara/b83b4f7c22a9086f4e1f8c8ce8e0cece97ea2a21
