...
Version  : 0.4.1
Release  : 9
URL      : https://github.com/pwmt/girara/archive/0.4.1/girara-0.4.1.tar.gz
Source0  : https://github.com/pwmt/girara/archive/0.4.1/girara-0.4.1.tar.gz
...
%prep
%setup -q -n girara-0.4.1
cd %{_builddir}/girara-0.4.1
pushd ..
cp -a girara-0.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703618109
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgirara-gtk3.so.3.1
